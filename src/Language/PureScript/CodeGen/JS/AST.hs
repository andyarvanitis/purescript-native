...
data JS
  ...
  -- |
  -- Access pointed-to object in expression
  --
  | JSFromPtr JS
  -- |
  ...
  -- |
  -- A sequence of statements with optional comment
  --
  | JSSequence String [JS]
  -- |
...
everywhereOnJS f = go
  ...
  go (JSFromPtr j) = f (JSFromPtr (go j))
...
everywhereOnJSTopDown f = go . f
  ...
  go (JSFromPtr j) = JSFromPtr (go (f j))
